...
public class ParseLogTest {
    ...
    public static void testGetRowKeyPart1() throws Exception{
        System.out.println(ParseLogsUtil.getRowKeyPart1("/Users/maicius/RestoreData/src/main/resources/200_localhost_access_log.2017-08-08.txt"));
    }
    public static void testParseLog() throws Exception{
        Date begin = new Date();
        List<LogData> list = ParseLogsUtil.parseLogsUtil("/Users/maicius/RestoreData/src/main/resources/gy_localhost_access_log.2017-08-08.txt");
